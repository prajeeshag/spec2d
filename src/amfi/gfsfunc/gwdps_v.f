       module gwdps_mod
        ...
        contains
CFPP$ NOCONCUR R                                                        
!     SUBROUTINE GWDPS(IM,im,im,KM,A,B,U1,V1,T1,Q1,PSTAR,KPBL,
      SUBROUTINE GWDPS(KM,A,B,U1,V1,T1,Q1,KPBL,
...
!   ********************************************************************
      ...
      integer km, imx, lat, ipr, me
      integer KPBL(IM)                 ! Index for the PBL top layer!
      real deltim, G, CP, RD, RV
!     real A(im,KM),    B(im,KM),      PSTAR(IM)
      real A(im,KM),    B(im,KM),
...
!
      real gor,    gocp,  fv,    xl,    gr2,  bnv,  fr
...
!
        ...
        enddo
!       if (lprnt) 
!    &  print *,' in gwdps_lm.f npt,IM,im,im,km,me=',npt,IM,im,im,km,me
!
!
...
!          endif
!        enddo
!     print *, ' mb: max(iwklm),jhit,phil,me=',
!    &          ihit,jhit,phil(jhit,ihit),me
...
!    & print *,' in gwdps_lmi.f I,K,DB(I,K),
...
!92         CONTINUE
!CMIC$ END GUARD 37
!123        FORMAT('  *** MIGWD PRINT *** I=',I3,' LAT=',I3,' I3)
