...
paths=$thisdir/amfi/spec_dyn/transforms/
#--------------------------------------------------------------------------------	
...
cppDef="-Duse_netCDF -Duse_libMPI  -Dtest_grid_fourier " 
...
mpirun -np 2 -prepend-rank $thisdir/exec/${EXE}/${EXE}.exe
